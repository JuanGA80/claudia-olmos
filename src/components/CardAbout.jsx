  ...
  return (
    <article className='w-full flex justify-center items-center flex-col rounded-xl shadow-xl shadow-gray-600/80 md:flex-row'>
      ...
      <div className='px-4 w-full flex justify-center items-center flex-col py-8 text-center md:px-20'>
        <h4 className='font-bold text-xl text-primary mb-2 lg:text-3xl'>Conoce a nuestro especialista</h4>
        ...
        <a
          ...
          className='select-none rounded-lg bg-secondary py-3 px-6 text-center align-middle font-semibold text-white shadow-md shadow-blue-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none'
          href='/nosotros'
        >
          Ver curriculum
        </a>
