    ...
    <footer className='w-full flex justify-center items-center bg-gradient-to-r from-primary to-secondary text-white py-4 mt-10' id='footer' ref={elementRef}>
      <div className='w-full flex justify-center items-center flex-col px-4 text-center lg:flex-row lg:justify-between md:max-w-8xl'>
        ...
        <div className='w-44 mt-4 flex justify-between items-center'>
          ...
          <a title='Ir a la página de Instagram de Dra. Claudia Olmos' href='https://www.instagram.com/dental_luda' className='w-12 h-12 rounded-full border-white border-2 flex justify-center items-center transition duration-300 fill-white hover:duration-300 hover:transition hover:bg-white hover:text-gray-800' target='_blank' rel='noopener noreferrer'>
            <Instagram className='w-5 h-5' />
          </a>
          <a title='Ir a la página de Facebook de Dra. Claudia Olmos' href='https://www.facebook.com/Dra. Claudia Olmos' className='w-12 h-12 rounded-full border-white border-2 flex justify-center items-center transition duration-300 fill-white hover:duration-300 hover:transition hover:bg-white hover:text-gray-800' target='_blank' rel='noopener noreferrer'>
